...
public class Guest {
    ...
    public boolean equals(Object o) {
        ...
        Guest guest = (Guest) o;
        return loyaltyProgramMember == guest.loyaltyProgramMember && Objects.equals(firstName, guest.firstName) && Objects.equals(lastName, guest.lastName) && Objects.equals(preferredRooms, guest.preferredRooms);
    }

    @Override
    public int hashCode() {
        return Objects.hash(firstName, lastName, loyaltyProgramMember, preferredRooms);
    }

    @Override
    public String toString() {
        return "SortingCollections.Guest: " + firstName;
    }
}
